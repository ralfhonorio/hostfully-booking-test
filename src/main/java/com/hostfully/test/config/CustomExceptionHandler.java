...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<Map<String, List<String>>> handleBookingNotAvailableException(BookingNotAvailableException ex) {
        List<String> errors = Collections.singletonList(ex.getMessage());
        return new ResponseEntity<>(getErrorsMap(errors), new HttpHeaders(), HttpStatus.CONFLICT);
    }

    @ExceptionHandler(DataNotFoundException.class)
    public ResponseEntity<Map<String, List<String>>> handleBookingNotAvailableException(DataNotFoundException ex) {
        List<String> errors = Collections.singletonList(ex.getMessage());
